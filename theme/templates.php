...
if (isset($search)) {
  $sql = "SELECT * FROM tblpeople WHERE FNAME LIKE '%" . $search . "%' OR LOCATION LIKE '%" . $search . "%' OR GRAVENO LIKE '%" . $search . "%' OR CATEGORIES LIKE '%" . $search . "%' LIMIT $start, $end";
  $mydb->setQuery($sql);
  $cur = $mydb->executeQuery();
        ...
        <footer class="footer">
          ...
          ?>
            ...
            <p>
              ...
              </script> All rights reserved | Cemetery Mapping and Information System.
            </p>
          <?php
          } else {
          ?>
