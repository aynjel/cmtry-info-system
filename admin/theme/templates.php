...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Howdy, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px" src="https://ui-avatars.com/api/?name=<?php echo $_SESSION['U_NAME']; ?>background=random&color=000&rounded=true&size=32&bold=true&length=1&format=svg">  
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                          ...
                          <div class="divpic"> 
                            <a href="" data-target="#usermodal"  data-toggle="modal" > 
                                <img title="profile image" width="70" height="80" src="https://ui-avatars.com/api/?name=<?php echo $_SESSION['U_NAME']; ?>background=random&color=000&rounded=true&size=32&bold=true&length=1&format=svg">
                            </a>
                          </div> 
