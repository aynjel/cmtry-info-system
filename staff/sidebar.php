          ...
          <div class="row">
            <div class="col-md-12">
              <div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
                <img src="https://ui-avatars.com/api/?name=<?php echo $_SESSION['U_NAME']; ?>&background=c4c962&color=fff&rounded=true&size=32&bold=true&format=svg">
                <div>
                <h4><?php echo $_SESSION['U_NAME']; ?></h4>
                <span style="background: green; color: #fff; padding: 2px 4px; border-radius: 5px;"><?php echo $_SESSION['U_ROLE']; ?></span>
                </div>
              </div>
            </div>
          </div>
