											...
											if ($res->GRAVENO == $count) {
												if (isset($_GET['name'])) {
													if (isset($_GET['name']) && $res->PEOPLEID == $_GET['id']) {
														echo "<td style='background: blue; cursor: pointer; color: #fff;' title='$res->FNAME'><a style='color: white;' href='index.php?q=person-info&id=$res->GRAVENO&name=$res->FNAME'>$count</a></td>";
													} else {
														echo "<td style='background: red; cursor: pointer;' title='$res->FNAME'><a style='color: white;' href='index.php?q=person-info&id=$res->GRAVENO&name=$res->FNAME'>$count</a></td>";
													}
												} else {
