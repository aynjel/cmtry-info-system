  ...
  <div class="main-wrapper">
      <div class="header header-one">
          ...
          <ul class="nav nav-tabs user-menu">
              <li class="nav-item">
                  <a class="nav-link <?php echo ($q == 'login') ? 'active' : ''; ?>" href="<?= web_root; ?>index.php?q=login">Login</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link <?php echo ($q == 'register') ? 'active' : ''; ?>" href="<?= web_root; ?>index.php?q=register">Register</a>
              </li>
          </ul>
      </div>
                                              ...
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              ...
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-04.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-06.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-08.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-10.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-11.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-05.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-07.jpg"
                                          ...
                                          <tr>
                                              <td>
                                                  <h2 class="table-avatar">
                                                      <a href="profile.html"><img
                                                              class="avatar avatar-sm me-2 avatar-img rounded-circle"
                                                              src="<?= web_root; ?>template/assets/img/profiles/avatar-09.jpg"
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse bigMenu" style="float:right" > 
      <ul class="nav navbar-nav" > 
        <li class="dropdown dropdown-toggle <?= ($q=='home') ? "active" : false;?> ">
          <a href="<?= web_root.'index.php?q=home'; ?>"> Home</a>
        </li>
        <li class="dropdown dropdown-toggle <?= ($q=='person') ? "active" : false;?>">
          <a href="<?= web_root.'index.php?q=person'; ?>"> Deceased Person</a>
        </li>
        <li class="dropdown-toggle <?= ($q=='contact') ? "active" : false;?>">
          <a href="<?= web_root.'index.php?q=contact';  ?>"> Contact Us</a>
        </li>
          <li class="dropdown-toggle <?= ($q=='about') ? "active" : false;?>">
          <a href="<?= web_root.'index.php?q=about';  ?>"> About Us</a>
        </li>
        <li class="dropdown dropdown-toggle <?= ($q=='login') ? "active" : false;?> ">
          <a href="<?= web_root.'index.php?q=login'; ?>"> Login</a>
        </li>
        <li class="dropdown dropdown-toggle <?= ($q=='register') ? "active" : false;?>">
          <a href="<?= web_root.'index.php?q=register'; ?>"> Register</a>
        </li>
      </ul>           
    </div> 
  </div>
